...
public class UserUpdateDto {
    ...
    // Role / user type
    @Pattern(regexp = "^(SUPER_ADMIN|MEDICAL_REVIEWER|MEDICAL_REVIEW_HEAD|ACCOUNTANT|PROVIDER_STAFF|EMPLOYER_ADMIN|DATA_ENTRY|FINANCE_VIEWER)$", message = "نوع المستخدم غير صالح")
