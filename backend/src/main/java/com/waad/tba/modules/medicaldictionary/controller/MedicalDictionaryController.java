...
public class MedicalDictionaryController {
    ...
    @PreAuthorize("@permissionGuard.has('SYSTEM_SETTINGS_MANAGE') and @permissionGuard.has('PRICE_LIST_IMPORT')")
    ...
    @GetMapping("/match")
    @PreAuthorize("@permissionGuard.has('PRICE_LIST_IMPORT') or @permissionGuard.has('CLAIM_CREATE') or @permissionGuard.has('PREAUTH_CREATE')")
    ...
    @PreAuthorize("@permissionGuard.has('PRICE_LIST_IMPORT') or @permissionGuard.has('PRICE_LIST_POST')")
    ...
    @PreAuthorize("@permissionGuard.has('PRICE_LIST_POST')")
