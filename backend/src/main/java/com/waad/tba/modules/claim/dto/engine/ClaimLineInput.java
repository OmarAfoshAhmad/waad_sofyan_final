...
public class ClaimLineInput {
    ...
    /**
     * معرّف التصنيف الطبي للخدمة كما وصل من الواجهة/المسودة القديمة.
     * عند وجود pricingItemId يكون تصنيف عقد المزود هو المصدر المالي الحاكم
     * ويُعاد ضبط هذا الحقل منه قبل طلب قرار التغطية.
     */
    private Long categoryId;

    /**
     * معرّف تصنيف الخدمة كما يعرفه عقد المزود أو فهرس الخدمة.
     * هذا تصنيف للخدمة فقط؛ سياق المطالبة يُرسل على رأس المطالبة كاملة
     * ولا يختلط بهذا الحقل.
     */
