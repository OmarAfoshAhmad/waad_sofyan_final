...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("SELECT u FROM User u WHERE " +
           "waad_search_normalize(u.username) LIKE CONCAT('%', :query, '%') OR " +
           "waad_search_normalize(u.fullName) LIKE CONCAT('%', :query, '%') OR " +
           "waad_search_normalize(u.email) LIKE CONCAT('%', :query, '%')")
