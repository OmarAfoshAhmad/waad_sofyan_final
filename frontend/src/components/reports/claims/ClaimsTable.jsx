    ...
    return (
      <Box sx={{ width: '100%', mb: 1, border: '1px solid rgba(0,0,0,0.05)', borderRadius: 1, overflow: 'hidden' }}>
        ...
        <Table size="small" sx={{ minWidth: '43.75rem' }}>
          <TableHead>
            <TableRow>
              <TableCell align="right" width={280} sx={{ fontWeight: 800, py: 1, bgcolor: '#fcfcfc' }}>
                الخدمة الطبية
              </TableCell>
              <TableCell align="center" width={45} sx={{ fontWeight: 800, py: 1, bgcolor: '#fcfcfc' }}>
                الكمية
              </TableCell>
              <TableCell align="center" width={70} sx={{ fontWeight: 800, py: 1, bgcolor: '#fcfcfc' }}>
                سعر الوحدة
              </TableCell>
              <TableCell align="center" width={60} sx={{ fontWeight: 800, py: 1, bgcolor: '#fcfcfc' }}>
                التحمل %
              </TableCell>
              <TableCell align="center" width={90} sx={{ fontWeight: 800, py: 1, bgcolor: '#fcfcfc' }}>
                سقف المنفعة
              </TableCell>
              <TableCell align="center" width={90} sx={{ fontWeight: 800, py: 1, bgcolor: '#fcfcfc' }}>
                الرصيد المتبقي
              </TableCell>
              <TableCell align="center" width={100} sx={{ fontWeight: 800, py: 1, bgcolor: '#fcfcfc' }}>
                شركة / مشترك
              </TableCell>
              <TableCell align="center" width={75} sx={{ fontWeight: 800, py: 1, bgcolor: '#fcfcfc' }}>
                المرفوض
              </TableCell>
              <TableCell align="center" width={80} sx={{ fontWeight: 800, py: 1, bgcolor: '#fcfcfc' }}>
                الإجمالي
              </TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {lines.map((line) => (
              <TableRow
                key={line.id}
                hover
                sx={{ '& td': { py: 0.6, px: '0.75rem' }, ...(line.rejected && { bgcolor: 'rgba(211, 47, 47, 0.05)' }) }}
              >
                <TableCell align="right">
                  <Stack spacing={0.5} alignItems="flex-start">
                    <Typography
                      variant="body2"
                      sx={{ fontWeight: 800, fontSize: '0.8rem', color: line.rejected ? 'error.main' : 'text.primary' }}
                    >
                      {line.serviceName}
                    </Typography>
