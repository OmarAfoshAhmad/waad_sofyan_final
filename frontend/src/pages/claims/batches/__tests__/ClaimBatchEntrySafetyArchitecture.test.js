...
describe('claim batch entry safety boundary', () => {
  ...
  it('does not force a blank cover page between the claim report letter and detail table', () => {
    expect(claimReportTemplate).toContain('INTRO LETTER');
    expect(claimReportTemplate).toContain('page-break-after: auto');
    expect(claimReportTemplate).not.toContain('page-break-after: always');
    expect(claimReportTemplate).not.toContain('min-height: 236mm');
