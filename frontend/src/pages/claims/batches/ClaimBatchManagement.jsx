    ...
    >
      <CardContent sx={{ p: '1.25rem', flexGrow: 1, display: 'flex', flexDirection: 'column', '&:last-child': { pb: '1.25rem' } }}>
        ...
        <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: '1.0rem' }}>
          ...
          <Typography variant="caption" dir="ltr" sx={{ color: '#aaa', fontWeight: 400, letterSpacing: 0.5, fontFamily: 'monospace' }}>
            {batchCode}
          </Typography>
        </Stack>
        ...
        <Box>
          <Stack direction="row" alignItems="center" justifyContent="center" spacing={2} sx={{ mb: '0.75rem' }}>
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', px: { xs: 2, sm: 3 } }}>
      ...
      <ModernPageHeader
        ...
        icon={ReceiptIcon}
        breadcrumbs={[{ label: 'الرئيسية', path: '/' }, { label: 'المطالبات والموافقات', path: '/claims' }, { label: 'نظام الدفعات' }]}
        actions={
            ...
            <MainCard sx={{ p: '8px !important' }}>
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                <Typography variant="subtitle2" fontWeight="bold">
                  مقدمو الخدمات لجهة عمل:{' '}
                  <Typography component="span" color="primary.main" variant="inherit">
                    {selectedEmployer.label || selectedEmployer.name}
                  </Typography>
                </Typography>
